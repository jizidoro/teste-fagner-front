...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  sidenavOpen!: Observable<boolean> | any;
  sidenavCollapsed!: Observable<boolean> | any;
  sidenavAlign: 'start' | 'end' = 'start';
  // 'over' | 'push' | 'side'
  sidenavMode: MatDrawerMode = 'side';
  sidenavDisableClose!: Observable<boolean> | any;

  quickpanelOpen!: Observable<boolean> | any;
  quickpanelAlign: 'start' | 'end' = 'end';
  // 'over' | 'push' | 'side'
  quickpanelMode: MatDrawerMode = 'side';

  layoutBoxed!: Observable<boolean> | any;

  settingsOpen!: Observable<boolean> | any;
